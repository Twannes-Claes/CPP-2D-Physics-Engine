...
{
public:
	explicit PhysicsWorld(const float gravity = 9.81f, const int pixelsPerMeter = 25) :Gravity(gravity), m_PixelsPerMeter(pixelsPerMeter){}
	~PhysicsWorld();
	...
	//Public because it is interactable as a property
	float Gravity{};
